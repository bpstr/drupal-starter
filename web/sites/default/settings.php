 ...
 * @endcode
 */
$settings['hash_salt'] = 'VFQaPtlp68VMpMg_YGEBV9UkYvql-0eK5Xbsb9SRG718U_efBrOnMb47qGcKu_R8rHZhGh_u0Q';
...
if (file_exists($app_root . '/' . $site_path . '/settings.local.php') &&
    !file_exists($app_root . '/' . $site_path . '/settings.prod.php')) {
